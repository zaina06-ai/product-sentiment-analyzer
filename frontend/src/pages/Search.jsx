...
export default function Search({ onResults }) {
  ...
  async function handleSearch(e) {
    ...
    const { data, error: apiError } = await searchProduct(query.trim(), "flipkart");
  ...
  return (
    <section className="hero">
      ...
      <p className="subhead">
        Pull real reviews for any product on Flipkart and turn them into a
        signal — positive, neutral, negative — scored by TextBlob and VADER.
      </p>
